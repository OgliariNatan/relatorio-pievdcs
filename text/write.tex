...
\par Em testes com uma massa de dados elevada, o tempo de resposta para consultas completas ultrapassava 70 segundos, tornando a ferramenta impraticável para uso em campo. Para resolver essa questão, foi realizado um trabalho de otimização focado em duas frentes:
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \caption{Tempo das consulta de Medidas Protetivas após otimização.}
    \includegraphics[width=1\textwidth]{figure/PM/Consulta_otimizada-PM.png}
    
    \label{fig:consulta_pm_otimizada}
    {\fontsize{10pt}{\baselineskip}\selectfont
   Fonte: O autor (2026)}
\end{figure}
