...
\begin{figure}[H]
    \center
    \caption{Consulta da Polícia Militar com paginação}
    \includegraphics[scale=0.35]{figure/PM/Consulta_otimizada-PM.png}
...
\par A figura \ref{fig:consulta_pm_otimizada} ilustra a consulta do módulo da Polícia Militar, onde é possível visualizar a implementação da paginação dinâmica que permite navegação eficiente mesmo com a base completa de 6.000 registros de teste. A interface apresenta tempos de resposta consistentes independente do volume total de dados cadastrados.
