...
\par O módulo de mensageria permite que usuários e instituições troquem mensagens e notificações de forma instantânea dentro da plataforma. Sustentado pela infraestrutura de \textbf{Django Channels} e \textbf{Redis} descrita na seção \ref{sec:channels_redis}, o módulo expõe ao usuário final as seguintes funcionalidades:
...
\begin{itemize}
   ...
   \item Classificação por prioridade — \textbf{Normal}, \textbf{Urgente} e \textbf{Crítica} — destacando situações de risco imediato;
